        ...
        <DashboardNavbar 
          ...
          onSecondaryAction={
            (postStatus === "Scheduled" || postStatus === "Draft")
              ...
              : () => router.push(fromList ? `/dashboard/marketing/blog` : `/dashboard/marketing/blog/${unwrappedParams.id}`)
          }
          onTertiaryAction={
            (postStatus === "Scheduled" || postStatus === "Draft")
              ? () => router.push(fromList ? `/dashboard/marketing/blog` : `/dashboard/marketing/blog/${unwrappedParams.id}`) // Discard is tertiary for drafts
              : undefined
          }
        />
