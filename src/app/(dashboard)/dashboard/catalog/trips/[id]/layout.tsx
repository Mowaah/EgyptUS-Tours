  ...
  return (
    <div className={styles.page}>
          ...
          primaryAction={
            isArchived
              ? {
                  ...
                  onClick: () => {
                    setIsArchived(false);
                    setBannerMessage("The trip has been published successfully");
                  },
                }
              : undefined
          }
      ...
      <DashboardConfirmationModal
        ...
        title="Delete Trip"
        message={`Are you sure you want to delete "${MOCK_TRIP.name}"? This action cannot be undone.`}
      ...
      <DashboardConfirmationModal
        ...
        onConfirm={() => {
          ...
          setIsArchived(true);
          setBannerMessage("The trip has been archived successfully and is no longer visible in the active trips list");
        }}
        title="Archive Trip?"
