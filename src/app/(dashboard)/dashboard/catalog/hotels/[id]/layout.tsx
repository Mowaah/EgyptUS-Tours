...
export default function HotelLayout({
  ...
  return (
    <div className={styles.page}>
      ...
      >
        <ProfileHeader
          title={`${MOCK_HOTEL.id} - ${MOCK_HOTEL.name}`}
          subtitleElements={["Elegant riverside hospitality and premium comfort"]}
          ...
          primaryAction={
            isArchived
              ? {
                  ...
                  onClick: () => {
                    setIsArchived(false);
                    setBannerMessage("The hotel has been published successfully");
                  },
                }
              : undefined
          }
      ...
      <DashboardConfirmationModal
        ...
        title="Delete Hotel"
        message={`Are you sure you want to delete "${MOCK_HOTEL.name}"? This action cannot be undone.`}
      ...
      <DashboardConfirmationModal
        ...
        onConfirm={() => {
          ...
          setIsArchived(true);
          setBannerMessage("The hotel has been archived successfully and is no longer visible in the active hotels list");
        }}
        title="Archive Hotel?"
