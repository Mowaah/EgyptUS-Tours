    ...
    async function loadPost() {
      try {
        ...
        setPost({
          ...
          thumbnailTitle: translation.thumbnail_title || data.thumbnail_title || "",
          thumbnailAlt: translation.thumbnail_alt || data.thumbnail_alt || "",
          imageTitle: translation.image_title || data.image_title || "",
          imageAlt: translation.image_alt || data.image_alt || "",
          metaTitle: translation.meta_title || data.meta_title || "",
          metaDescription: translation.meta_description || data.meta_description || translation.short_description || data.excerpt || "",
