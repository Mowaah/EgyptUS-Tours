...
export default function ChatBot() {
  ...
  return (
    <div className={styles.chatbotContainer}>
        ...
        <div className={styles.chatWindow}>
          <header className={styles.header}>
            <div className={styles.headerLeft}>
              <Image src="/images/robot.svg" alt="Bot" width={52} height={52} className={styles.headerBotIcon} />
      ...
      >
        <Image src="/images/robot.svg" alt="Chat Bot" width={77.5} height={77.5} className={styles.triggerIcon} />
      </button>
    </div>
  );
}
